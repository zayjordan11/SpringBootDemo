...
public interface ShopRepo extends JpaRepository<Shop,Integer> {
     ...
     * allowing for the removal of the DAO implementation and only requiring
     * the definition of the DAO interface methods.
     *
     * In order to leverage the Sping Data programming model with JPA, a DAO
     * interface should extend the Spring JpaRepository interface from the
    ...
    //example of an uodate method using @Query
